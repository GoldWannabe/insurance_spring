...
<form action ="finishSales">
	...
	<form action="join" >
		...
		전화번호: <input type="text" name="phoneNum" onkeyup="noSpaceForm(this);" required><br>
		...
		계좌번호: <input type="text" name="accountNum"onkeyup="noSpaceForm(this);" required><br>
		...
		스케일(Int): <input type="text" name="scale"placeholder="정수" onkeyup="noSpaceForm(this);" required><br>
