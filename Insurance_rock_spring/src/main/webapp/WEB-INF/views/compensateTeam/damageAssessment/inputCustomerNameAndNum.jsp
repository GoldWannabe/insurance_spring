...
<p>고객님의 계약 중 사고를 추가할 계약을 검색합니다.</p>
	<form action="inputCustomerNameAndNum">
		...
		연락처: <input type="number" name="customerPhoneNum" placeholder="ex)000-0000-0000" onkeyup="noSpaceForm(this);"  required  oninvalid="this.setCustomValidity('입력되지 않은 입력란이 존재합니다.\n모든 입력란에는 반드시 정보를 입력해야 합니다.')"><br>
